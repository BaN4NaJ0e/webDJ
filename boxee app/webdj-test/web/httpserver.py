...
def runsimple(func, server_address=("0.0.0.0", 8080)):
    ...
    try:
        server.start()
    except KeyboardInterrupt or serverstopcondition:
        server.stop()

#def stopsimple(func, server_address=("0.0.0.0", 8080)):
#    """
#    tries to stop the currently running webserver
#    """
#    print "creating wsgi server object and stopping it"
#    server = WSGIServer(server_address, func)
#    server.stop()
